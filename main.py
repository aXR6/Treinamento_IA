...
from config import (
    ...
    MINILM_L6_V2, MINILM_L12_V2, MPNET_EMBEDDING_MODEL, QWEN3_EMBEDDING_MODEL,
    DIM_MXBAI, DIM_SERAFIM, DIM_MINILM_L6, DIM_MINIL12, DIM_MPNET, DIM_QWEN3,
