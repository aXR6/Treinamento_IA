...
CHUNKING_POLICIES = {
    "long_text": SemanticChunker(window_size=1000, stride=200, pad=50),
    "scanned":   SlidingWindowChunker(window_size=500, stride=100, pad=25),
    "default":   SemanticChunker(window_size=800, stride=200, pad=50),
}
