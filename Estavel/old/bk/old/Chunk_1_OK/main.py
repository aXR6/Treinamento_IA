...
from utils import chunk_text  # não usado aqui, mas disponível
...
# Setup de logging e supressão de warnings
...
def process_file(path, strategy, db_choice, results):
    ...
    # extrai o texto (com fallback OCR se necessário)
    ...
    if db_choice == "mongo":
        ...
        # aqui save_to_postgres fará chunking e salvará múltiplos registros
